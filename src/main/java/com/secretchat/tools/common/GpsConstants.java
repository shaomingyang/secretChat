...
public class GpsConstants {
	...
	// 文本信息下发
	public static final int cmd_terminal_text_issued = 0x8300;
	
	
	// 位置汇报信息附加信息标志
	// 车辆里程
	public static final int attach_sign_terminal_location_mile= 0x01;
	// 油量
	public static final int attach_sign_terminal_location_oil= 0x02;
}
